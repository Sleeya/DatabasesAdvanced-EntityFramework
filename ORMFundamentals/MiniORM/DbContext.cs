    ...
    public abstract class DbContext
    {
        ...
        public void SaveChanges()
        {
            ...
            foreach (IEnumerable<object> dbSet in dbSets)
            {
                ...
                {
                    throw new ArgumentException($"{invalidEntities.Length} Invalid Entities found in {dbSet.GetType().Name}");
                }
            }
        ...
        private void MapAllRelations()
        {
            foreach (var dbSetProperty in dbSetProperties)
            {
                ...
                var mapRelationsGeneric = typeof(DbContext).GetMethod("MapRelations", BindingFlags.Instance | BindingFlags.NonPublic).MakeGenericMethod(dbSetType);
