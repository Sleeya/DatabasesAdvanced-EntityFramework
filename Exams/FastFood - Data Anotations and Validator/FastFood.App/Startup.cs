...
namespace FastFood.App
{
	public class Startup
	{
        ...
        { 
            using (FastFoodDbContext context = new FastFoodDbContext())
            {
		...
		private static void ImportEntities(FastFoodDbContext context )
		{
            //string baseDir = @"../../../Files/Import/";
            //string exportDir = "../../../Files/Export/";
		...
		{
			const string exportDir = "../../../Files/Export/";
